...
const GetTourCat = () => {
  ...
  const [filter, setFilter] = useState<TourCategory[] | null>([]);
        ...
        <div className="flex justify-between flex-wrap gap-y-5">
          <div>
            ...
            <p className="mt-2 text-xs md:text-lg">
              List of Tour Category on Toursewa
            </p>
          </div>
          <Link
            to="/admin/tourcategory/addtourcategory"
                    ...
                    {filter &&
                      filter.map((category, i) => (
                        <tr key={category._id}>
                          ...
                          <td className="border font-normal relative border-gray-500 text-center">
                            <span
                          ...
                          <td className="flex justify-between flex-col border gap-6 border-b-0  text-white p-2 ">
                            <div className="flex gap-4 md:gap-7">
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/admin/tourcategory/updattourcategory/${category.categoryId}`
                                  )
                                }
                                title="Edit"
                              >
                              ...
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/admin/tourcategory/addsubcategory/${category.categoryId}`
                                  )
                                }
                              >
                                <FontAwesomeIcon
