...
export const UpdateTrek = () => {
  ...
  const updateTrek = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("businessId", authUser?.businesId || "");
          ...
          <div className="flex flex-col">
            ...
            >
              <div className="space-y-1 flex flex-wrap justify-center gap-y-5 gap-x-12 text-sm w-full">
                ...
                <div className="flex flex-col w-11/12 sm:w-1/3  gap-y-3 md:gap-y-5">
              ...
              <div className="flex flex-col  w-2/5 sm:w-1/3 gap-y-3 md:gap-y-5">
                <h1>Treck Images</h1>
                <input
                  type="file"
                  name="trek_images"
