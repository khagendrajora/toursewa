...
const GetTrekCat = () => {
  ...
  const [filter, setFilter] = useState<TrekCategory[] | null>([]);
        ...
        <div className="flex justify-between flex-wrap gap-y-5">
          <div>
            ...
            <p className="mt-2 text-xs md:text-lg">
              List of Trek Category on Toursewa
            </p>
          </div>
          <Link
            to="/admin/trekcategory/addtrekcategory"
                          ...
                          <td className="flex justify-between flex-col border gap-6  text-white p-2 ">
                            <div className="flex gap-4 md:gap-7">
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/admin/trekcategory/updattrekcategory/${category.categoryId}`
                                  )
                                }
                                title="Edit"
                              >
                              ...
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/admin/trekcategory/addsubcategory/${category.categoryId}`
                                  )
                                }
                              >
                                <FontAwesomeIcon
