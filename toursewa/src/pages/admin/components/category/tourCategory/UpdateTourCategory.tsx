...
const UpdateTourCategory = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`${URL}/api/tourcategorydetail/${id}`);
  ...
  const update = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${URL}/api/updatetourcategory/${id}`, {
        method: "PUT",
        headers: {
...
export default UpdateTourCategory;
