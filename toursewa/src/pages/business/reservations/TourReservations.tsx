...
import {
  ITuRev,
  IStatus,
} from "../../../.../../SharedTypes/Reservations/TourReservation/tourRevModel";
      ...
      <div className="h-screen flex flex-col gap-5">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-2 text-xs md:text-lg">Tour Reservations</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className=" flex justify-center flex-col pr-5 w-full items-center text-xs">
                    ...
                    filterSearch.map((filter, i) => (
                      <>
                        ...
                        >
                          ...
                          <td className="px-3  py-3">{filter?.tourName}</td>
                          ...
                          <td className="py-3">{filter?.tickets}</td>
                    ...
                    paginationData.map((data, i) => (
                      <>
                        ...
                        >
                          ...
                          <td className="px-3  py-3">{data?.tourName}</td>
                          ...
                          <td className=" py-3">{data?.tickets}</td>
